...
//        
//        ApiHandler.sharedInstance.updatePushNotificationSettings(user_id: UserDefaultsManager.shared.user_id, comments: self.newComments, new_followers: self.newFollowers, mentions: self.newMentions, likes: self.newLikes, direct_messages: self.directMsg, video_updates: self.videoUpdates) { (isSuccess, response) in
//            if isSuccess{
//                if response?.value(forKey: "code") as! NSNumber == 200{
//                    
//                    
