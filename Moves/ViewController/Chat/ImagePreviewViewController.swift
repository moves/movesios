...
//  GrabMyTaxi
//
//  Created by Arslan on 06/02/2021.
//  Copyright © 2021 Arslan. All rights reserved.
//
...
class ImagePreviewViewController: UIViewController, UIScrollViewDelegate
{
    ...
    override func viewDidLoad()
    {
        ...
        imageView.sd_setImage(with: URL(string:imgUrl), placeholderImage: UIImage(named: "placeholder 2"))
